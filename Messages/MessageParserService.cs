  ...
  public sealed class MessageParserService {
    ...
    public IrcMessage Parse(String unparsedMessage) {
      ...
      if (unparsedMessage.Length < MinMessageLength || MaxMessageLength < unparsedMessage.Length) {
        InvalidMessageException e = new InvalidMessageException(String.Format(CultureInfo.InvariantCulture, Properties.Resources.MessageEmptyOrTooLong, unparsedMessage.Length), unparsedMessage);
        throw (e);
      }
