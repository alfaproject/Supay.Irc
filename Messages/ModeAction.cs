...
namespace Supay.Irc.Messages {
  ...
  /// <summary>
  /// Possible actions for each mode change in a <see cref="Supay.Irc.Messages.ChannelModeMessage"/> or <see cref="Supay.Irc.Messages.UserModeMessage"/> message.
  /// </summary>
  ...
  public sealed class ModeAction : MarshalByRefObject, IComparable, ISerializable {
    ...
    public int CompareTo(object obj) {
      ...
      if (ma == null) {
        throw new ArgumentException(String.Format(CultureInfo.InvariantCulture, Properties.Resources.ObjectMustBeOfType, "ModeAction"), "obj");
      }
