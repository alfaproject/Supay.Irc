...
{
    /// <summary>
    /// A partial list of the codes that can exist in the <see cref="System.Net.Sockets.SocketException.ErrorCode"/>
    /// property.
    /// </summary>
    public enum SocketError
    {
        ...
        /// limit, or the buffer used to receive a datagram was smaller than the datagram itself.
        /// </summary>
        ...
        /// <summary>
        /// Typically, only one usage of each socket address (protocol/IP address/port) is permitted. This error occurs
        /// if an application attempts to bind a socket to an IP address/port that has already been used for an
        /// existing socket, or a socket that was not closed properly, or one that is still in the process of closing.
        /// </summary>
        ...
        /// <summary>
        /// The connection has been broken due to keep-alive activity detecting a failure while the operation was in
        /// progress.
        /// </summary>
        NetworkDroppedConnectionOnReset = 10052,

        /// <summary>
        /// An established connection was aborted by the software in your host computer, possibly due to a data
        ...
        /// <summary>
        /// A request to send or receive data was disallowed because the socket is not connected and no address was
        /// supplied.
        /// </summary>
        SocketIsNotConnected = 10057,

        /// <summary>
        /// A request to send or receive data was disallowed because the socket had already been shut down in that
        ...
        /// the established connection failed because the connected host has failed to respond.
        /// </summary>
        ...
        /// <summary>
        /// A Windows Sockets implementation may have a limit on the number of applications that can use it
        /// simultaneously.
        /// </summary>
        TooManyProcesses = 10067,

        /// <summary>
        /// This error is returned if the Windows Sockets implementation cannot function at this time because the
        /// underlying system it uses to provide network services is currently unavailable.
        /// </summary>
        NetworkSubsystemIsUnavailable = 10091,

        /// <summary>
        /// The current Windows Sockets implementation does not support the Windows Sockets specification version
        ...
        /// <summary>
        /// No such host is known. The name is not an official host name or alias, or it cannot be found in the
        /// database(s) being queried.
        /// </summary>
        HostNotFound = 11001,

        /// <summary>
        /// This is usually a temporary error during host name resolution and means that the local server did not
        /// receive a response from an authoritative server. A retry at some time later may be successful.
        /// </summary>
        ...
        /// <summary>
        /// The requested name is valid and was found in the database, but it does not have the correct associated data
        /// being resolved for.
        /// </summary>
